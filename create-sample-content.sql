...
INSERT INTO tracks (id, name, description, created_at, updated_at)
VALUES (
    gen_random_uuid(),
...
INSERT INTO cohorts (id, name, start_date, end_date, created_at, updated_at)
VALUES (
    gen_random_uuid(),
    'Cohort 2024-A',
    '2024-01-01',
...
INSERT INTO weeks (id, track_id, week_number, title, description, created_at, updated_at)
SELECT 
    gen_random_uuid(),
    track_info.track_id,
    1,
...
INSERT INTO lessons (id, week_id, title, type, content, created_at, updated_at)
SELECT 
    gen_random_uuid(),
    week_info.week_id,
    'HTML Fundamentals',
...
INSERT INTO assignments (id, week_id, title, requirements, submission_guidelines, deadline, created_at, updated_at)
SELECT 
    gen_random_uuid(),
    week1.week_id,
...
INSERT INTO student_enrollments (id, user_id, track_id, cohort_id, progress_percentage, created_at, updated_at)
SELECT 
    gen_random_uuid(),
